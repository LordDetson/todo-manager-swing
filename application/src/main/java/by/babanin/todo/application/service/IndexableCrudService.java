...
public abstract class IndexableCrudService<E extends Persistent<I> & Indexable, I> extends AbstractCrudService<E, I> {

    protected IndexableCrudService(IndexableRepository<E, I> repository) {
        super(repository);
    }
