...
public class CustomFlatButtonUI extends FlatButtonUI {

    public static ComponentUI createUI(JComponent c) {
        return FlatUIUtils.canUseSharedUI(c)
                ? FlatUIUtils.createSharedUI(FlatButtonUI.class, () -> new CustomFlatButtonUI(true))
                : new CustomFlatButtonUI(false);
    }

    protected CustomFlatButtonUI(boolean shared) {
        super(shared);
    }
